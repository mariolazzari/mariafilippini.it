...
export function Work({ work }: WorkProps) {
  ...
  return (
    <div className="w-[350px] md:w-[400px] h-[450px] p-4 border border-secondary hover:border-primary shadow-xl rounded-xl bg-gradient-to-br from-background to-muted">
